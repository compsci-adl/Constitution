...
\begin{description}
    ...
    \item \defn{Executive} means the executive body (Executive Committee) of the Club;
    \item \defn{GM} means a General Meeting of the Club;
    \item \defn{Office} means an elected position in the Club provided for in Section~\ref{committeeComp};
...
\begin{enumerate}[(1)]
    ...
    \item Associate members must also satisfy the criteria under Section~\ref{generalMembership}. % PROPOSAL: Reword this clause
\end{enumerate}
